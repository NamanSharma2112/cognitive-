...
export default function SoundForestGame() {
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.header}>
        ...
        <ThemedText style={styles.title}>Sound Forest</ThemedText>
        <View style={{ width: 60 }} />
      </View>
      <View style={styles.center}>
        <View style={[styles.card, { backgroundColor: cardBg }]}>
          <ThemedText style={styles.emoji}>🌲</ThemedText>
          <ThemedText style={styles.gameTitle}>Sound Forest</ThemedText>
          <View style={styles.badge}>
            <ThemedText style={styles.badgeText}>Processing Speed</ThemedText>
          </View>
          <ThemedText style={styles.comingSoon}>Coming Soon</ThemedText>
          <ThemedText style={styles.desc}>
            Match sounds to images to train your auditory processing speed and cross-modal memory connection.
          </ThemedText>
        </View>
      </View>
    </ThemedView>
...
const styles = StyleSheet.create({
  ...
  back: { padding: 5 },
  backText: { fontSize: 20, fontWeight: '700', color: '#9B59B6' },
  ...
  badge: { backgroundColor: '#9B59B6' + '22', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  badgeText: { color: '#9B59B6', fontSize: 14, fontWeight: '700' },
