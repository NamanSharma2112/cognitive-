...
export default function DualTaskFlowGame() {
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={styles.header}>
        ...
        <ThemedText style={styles.title}>Dual Task Flow</ThemedText>
        <View style={{ width: 60 }} />
      </View>
      <View style={styles.center}>
        <View style={[styles.card, { backgroundColor: cardBg }]}>
          <ThemedText style={styles.emoji}>⚡</ThemedText>
          <ThemedText style={styles.gameTitle}>Dual Task Flow</ThemedText>
          <View style={styles.badge}>
            <ThemedText style={styles.badgeText}>Dual Task</ThemedText>
          </View>
          <ThemedText style={styles.comingSoon}>Coming Soon</ThemedText>
          <ThemedText style={styles.desc}>
            Manage two simultaneous cognitive tasks to build your multitasking ability and divided attention.
          </ThemedText>
        </View>
      </View>
    </ThemedView>
...
const styles = StyleSheet.create({
  ...
  back: { padding: 5 },
  backText: { fontSize: 20, fontWeight: '700', color: '#E67E22' },
  ...
  badge: { backgroundColor: '#E67E22' + '22', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  badgeText: { color: '#E67E22', fontSize: 14, fontWeight: '700' },
